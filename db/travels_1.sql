...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2021 at 06:15 PM
...
CREATE TABLE `booking` (
  ...
  `payment_method` enum('visa','mastercard','credit card','debit card') DEFAULT 'debit card',
  `payment_status` enum('success','fail') DEFAULT 'success'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `booking` (`id`, `tour_package_id`, `user_id`, `cost`, `adults`, `children`, `date_from`, `date_till`, `food_type`, `booking_time`, `payment_method`, `payment_status`) VALUES
(1, 1, 2, 134099.1, 1, 0, '0000-00-00', '0000-00-00', 'Veg', '2021-11-08 22:12:55', 'debit card', 'success'),
(2, 2, 2, 433035, 4, 2, '0000-00-00', '0000-00-00', 'Veg', '2021-11-08 22:16:44', 'debit card', 'success'),
(3, 1, 2, 134099.1, 1, 0, '0000-00-00', '0000-00-00', 'Veg', '2021-11-08 22:14:35', 'debit card', 'success'),
(5, 1, 2, 134099.1, 1, 0, '0000-00-00', '0000-00-00', 'Veg', '2021-11-09 21:47:19', 'debit card', 'success');
...
CREATE TABLE `feedback` (
  ...
  `image` varchar(200) NOT NULL DEFAULT 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'
...
INSERT INTO `feedback` (`id`, `name`, `email`, `referral`, `comment`, `image`) VALUES
(1, 'Shreyans', 'shreyans@gmail.com', 'Friends', 'Nice Website', 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'),
(2, 'Raj', 'raj@gmail.com', 'Friends', 'User Friendly', 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'),
(3, 'Ramavtar', 'ramu@gmail.com', 'Friends', 'Easy to Use', 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'),
(4, 'Trigya', 'trigya@gmail.com', 'Friends', 'Amazing Tours', 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg'),
(6, 'Harsh', 'harsh@gmail.com', 'Friends', 'Had fun on my tour', 'https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg');
...
CREATE TABLE `review` (
  `id` int(11) NOT NULL,
  `username` varchar(200) NOT NULL DEFAULT 'Anonymous',
  `tour_package_id` int(11) DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
...
INSERT INTO `review` (`id`, `username`, `tour_package_id`, `user_id`, `rating`, `title`, `description`, `date_added`) VALUES
(1, 'Sam', 2, 2, 5, 'Great Tour', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 14:55:40'),
(2, 'Shreyans', 2, 2, 5, 'Had a Blast', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 14:56:33'),
(3, 'Raj', 2, 2, 5, 'Very Fun', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 14:57:14'),
(4, 'Shreyans', 1, 2, 4, 'Amazing Tour', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 15:17:56'),
(5, 'Raj', 1, 1, 5, 'Baape', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 15:19:39'),
(6, 'Axon', 1, 3, 1, 'Good not great', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 15:20:59'),
(7, 'Shreyans', 1, 2, 4, 'Relaxing', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Est impedit optio soluta deleniti doloribus quae atque sequi quisquam a deserunt commodi quod quas voluptates voluptatem accusantium, voluptatibus ex? Cum consectetur aut ratione nesciunt, reprehenderit culpa earum error alias numquam suscipit fugit architecto! Sit repudiandae veritatis expedita, beatae pariatur odio soluta perferendis nobis labore cum ad dicta autem, aperiam iure officia?', '2021-11-08 15:23:21'),
(8, 'Shreyans', 1, 2, 4, 'Nice', 'Enjoyed my journey', '2021-11-10 00:01:46');

--
-- Triggers `review`
--
DELIMITER $$
CREATE TRIGGER `update_ratings` AFTER INSERT ON `review` FOR EACH ROW update tour_package set tour_package.rating=(select avg(rating) from review where review.tour_package_id=new.tour_package_id) where tour_package.id=new.tour_package_id
$$
DELIMITER ;
...
CREATE TABLE `tour_package` (
  ...
  `available_days` enum('Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday') DEFAULT 'Monday',
...
(3, 'axon', 'blaze', 'male', 'axon@example.com', '', '', 0, '', '', '2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824', 0, '2001-04-23', '2021-11-07');
